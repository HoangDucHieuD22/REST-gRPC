...
public class restpath_pathqueryvalidation {

    public static void main(String[] args) throws Exception {
        // --- KHAI BÁO ---
        String studentCode = "B22DCVT192"; // Thay mã sinh viên
        String qCode = "0njBzTrZ";         // Mã câu hỏi của bài này
        ...
        // a. Gửi GET đầu tiên để lấy danh sách hóa đơn
