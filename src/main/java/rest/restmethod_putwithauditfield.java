...
public class restmethod_putwithauditfield {

    public static void main(String[] args) throws Exception {
        // --- KHAI BÁO ---
        String studentCode = "B22DCVT192"; // Thay mã sinh viên
        String qCode = "jhyzYDQh";         // Mã câu hỏi của bài này
        ...
        // Tạo object answer theo yêu cầu
        var answer = Map.of(
                "status", "ACTIVE",
                "activatedBy", studentCode.toUpperCase() // Viết hoa mã sinh viên
        );

        // Tạo body JSON hoàn chỉnh, lồng object answer vào
